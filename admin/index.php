<?php include "includes/admin_header.php" ?>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class='huge'>
                                        <?php echo $category_count = recordCount('category'); ?>
                                    </div>
                                    <div>Categories</div>
                                </div>
                            </div>
            ...
            $unapproved_comment = checkStatus('comments', 'comment_status', 'unapproved');
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            $element_count = [$post_count, $post_published_count, $post_draft_count, $comment_count, $unapproved_comment, $user_count, $subscriber_count, $category_count];

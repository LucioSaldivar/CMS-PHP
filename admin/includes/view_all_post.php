    ...
    foreach ($_POST['checkBoxArray'] as $postValueId) {
        ...
        switch ($bulk_options) {
            ...
            case 'clone':
                ...
                $query = "INSERT INTO post(post_category_id,post_title,post_author,post_user,post_date,post_image,post_content,post_tags,post_status) ";
...
<form action="" method="post">
    <table class="table table-bordered table-hover">
        ...
        while ($row = mysqli_fetch_assoc($select_posts)) {
            ...
            <td>
                <input class='checkbox' type='checkbox' name='checkBoxArray[]' value='<?php echo $post_id; ?>'>
            </td>
            ...
            echo "<td><a href='../post.php?source=p_id={$post_id}'>View Post</a></td>";
